...
def train(input_height,input_width,input_chan,tfrec_dir,batchsize,learnrate,epochs,chkpt_dir,tboard):
    ...
    chkpt_call = ModelCheckpoint(filepath=os.path.join(chkpt_dir,'fruits_model.h5'), 
...
def run_main():
    ...
    ap.add_argument('-e', '--epochs',      type=int,   default=1,    help='number of training epochs. Must be an integer. Default is 100.')
