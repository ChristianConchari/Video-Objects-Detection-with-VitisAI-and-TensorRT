...
def main():
    ...
    ap.add_argument('-m', '--float_model',  type=str, default='float_model/fruits_model.h5', help='Full path of floating-point model. Default is float_model/k_model.h5')
    ap.add_argument('-q', '--quant_model',  type=str, default='quant_model/q_fruits_model.h5', help='Full path of quantized model. Default is quant_model/q_model.h5')
